function [Z1,ZSD1,ZUP,R,Rpls11,XmeanLoc,gpmodel1] = start_approx(X,Y1,X01,g)
...
---------------------------------------------------------------------------
Description:
* Train Gaussian process on low-dimensional subspace span by PLS projections for j=0
---------------------------------------------------------------------------
Input:
* X             : Samples
* Y1            : Evalutions
...
%}
%% Procedure to train Gaussian process on low-dimensional subspace span by PLS projections for j=0
...
ED1 = ED(T1,Tr1); % estimate distance between samples and LHS proposal
